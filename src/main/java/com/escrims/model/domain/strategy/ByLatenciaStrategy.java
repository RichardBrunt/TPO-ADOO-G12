...
public class ByLatenciaStrategy implements SelectionStrategy {
    @Override
    public List<Postulacion> seleccionar(List<Postulacion> postulaciones, int cantidad) {
        return postulaciones.stream()
                .sorted(Comparator.comparingInt(p -> {
                    ...
                    return stats != null ? stats.getLatenciaPromedio() : Integer.MAX_VALUE;
                }))
                .limit(cantidad)
    ...
    public String getNombre() {
        return "Selección por menor latencia";
    }
}
